...
class TAPoller(BasePoller):
    ...
    async def cycle(self) -> None:
        """Compute intraday TA, daily TA (once/day), prune old data, check paper stop-losses."""
        await self._compute_intraday()
        await self._compute_daily_if_due()
        await self._check_paper_stop_losses()
